...
- [x] **2.5** `UI` — Ingredient list editor — add, remove, reorder (drag handle via `LazyColumn` reorder); quantity / unit / prep-note fields; 48 dp min row height
...
- [x] **3.8** `UI` — Bottom navigation — 4-tab `NavigationBar` (M3 Expressive); tabs: Catalog, Scan, Planner, Profile; wired to Navigation 3 `NavController`; brand green active indicator
