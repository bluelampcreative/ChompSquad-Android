...
abstract class CoreViewModel<StateType, ActionType : ViewAction, UIEventType>(private val initialState: StateType) :
ViewModel(),
IViewStateHolder<StateType>,
UIEventHandler<UIEventType> {
