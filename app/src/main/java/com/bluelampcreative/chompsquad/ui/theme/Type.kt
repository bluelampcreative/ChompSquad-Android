...
/**
 * M3 type scale for ChompSquad. Sizes follow Material 3 spec; only styles used in the app are
 * overridden from defaults — the rest inherit from MaterialTheme.typography.
 */
val ChompTypography =
    Typography(
        // ── Display ──────────────────────────────────────────────────────────────
