...
fun RecipeDto.toImageEntities(): List<RecipeImageEntity> =
    images.map { it.toEntity(recipeId = id) }

fun RecipeDto.toIngredientEntities(): List<IngredientEntity> =
    ingredients.map { it.toEntity(recipeId = id) }

fun RecipeDto.toStepEntities(): List<StepEntity> =
    steps.map { it.toEntity(recipeId = id) }

private fun RecipeImageDto.toEntity(recipeId: String) = RecipeImageEntity(
    id       = id,
    recipeId = recipeId,
    blobPath = blobPath,
    url      = url,
...
private fun IngredientDto.toEntity(recipeId: String) = IngredientEntity(
    id       = id,
    recipeId = recipeId,
    position = position,
    quantity = quantity,
...
private fun StepDto.toEntity(recipeId: String) = StepEntity(
    id         = id,
    recipeId   = recipeId,
    position   = position,
...
private fun RecipeImageEntity.toDomain() = RecipeImage(
    id       = id,
    blobPath = blobPath,
    url      = url,
    position = position,
