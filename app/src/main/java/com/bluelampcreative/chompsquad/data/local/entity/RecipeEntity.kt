...
data class RecipeWithDetails(
    ...
    @Relation(parentColumn = "id", entityColumn = "recipe_id") val images: List<RecipeImageEntity>,
    @Relation(parentColumn = "id", entityColumn = "recipe_id")
    val ingredients: List<IngredientEntity>,
    @Relation(parentColumn = "id", entityColumn = "recipe_id") val steps: List<StepEntity>,
)
